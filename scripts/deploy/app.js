...
var require_showdown = __commonJS((exports2, module2) => {
...
var require_mkdirp = __commonJS((exports2, module2) => {
  ...
  mkdirp2.native = (path, opts) => mkdirpNative(pathArg(path), optsArg(opts));
  mkdirp2.manual = (path, opts) => mkdirpManual(pathArg(path), optsArg(opts));
  mkdirp2.nativeSync = (path, opts) => mkdirpNativeSync(pathArg(path), optsArg(opts));
  mkdirp2.manualSync = (path, opts) => mkdirpManualSync(pathArg(path), optsArg(opts));
...
var showdown = require_showdown();
var mkdirp = require_mkdirp();
var splitDir = __dirname.split("/");
splitDir.splice(splitDir.length - 2, 2);
var projectRoot = "";
splitDir.forEach((dirname) => {
  projectRoot += dirname + "/";
});
var outDir = projectRoot + config.out_dir;
...
function exportHTML(relativeDirPath, fileName, disableConvert = false) {
...
function mergeTemplate(convertedString, depth) {
